 ...
 *
 *  4. Добавь в разметку Button из библиотеки Material UI (@mui/material).
 ...
 *     const MyApp = () => (
 *        <div>
 *            Click this button <Button variant="contained" onClick={() => console.log('Hey!')}>Click me</Button>
 *        </div>
 *     );
 *
 *
 ...
 *
 *  5. Теперь, когда ты знаешь все основное, сверстай при помощи material-ui форму,
 *     как на картинке drafts/reactForm.png (можно открыть в браузере http://localhost:8080/drafts/reactForm.png)
 *     Для разметки элементов форм используй компонент https://mui.com/material-ui/react-grid/ из библиотеки.
 ...
 *
 *  7. Сделай так, чтобы в той же модалке (в теле модального окна — <Box></Box>) показывались изменения в полях.
